...
| backupJob.backup.image.tag | string | `"0.17.0"` |  |
...
| backupJob.init | object | `{"image":{"pullPolicy":"IfNotPresent","repository":"restic/restic","tag":"0.17.0"},"resources":{}}` | Configuration for the repository init container |
...
| cleanupJob.image.tag | string | `"0.17.0"` |  |
